...
from users.views import CustomTokenObtainPairView, UserProfileView, LogoutView
...
urlpatterns = [
    ...
    path('auth/users/reset_password/', UserViewSet.as_view({'post': 'reset_password'}), name='reset-password'),   # Password reset request
